...
class SunritJana:
    def __init__(self) -> None:
        ...
        self.tech_stack = {
            ...
            "branches": [
                "Machine Learning", "Full Stack development", "Automation", 
                "DevOps", "CLI, GUI and TUI", "Networking", "Ethical Hacking"
            ],
            "frontend": {
...
1. 🎉 Merged PR [#10](https://github.com/janaSunrise/wall-of-gif-solana/pull/10) in [janaSunrise/wall-of-gif-solana](https://github.com/janaSunrise/wall-of-gif-solana)
2. 🎉 Merged PR [#9](https://github.com/janaSunrise/wall-of-gif-solana/pull/9) in [janaSunrise/wall-of-gif-solana](https://github.com/janaSunrise/wall-of-gif-solana)
